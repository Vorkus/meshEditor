...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:fn,depthTest:!1,depthWrite:!1})}function Ga(){return new Un({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ts(),fragmentShader:`
		...
		`,blending:fn,depthTest:!1,depthWrite:!1})}function Va(){return new Un({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ts(),fragmentShader:`
...
}`;function sm(i){const e=document.createElement("style");e.innerHTML=i;const t=document.querySelector("head link[rel=stylesheet], head style");t?document.head.insertBefore(e,t):document.head.appendChild(e)}let _o=!1;class Ls{constructor({parent:e,autoPlace:t=e===void 0,container:n,width:r,title:s="Controls",closeFolders:o=!1,injectStyles:a=!0,touchStyles:l=!0}={}){if(this.parent=e,this.root=e?e.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",c=>{(c.code==="Enter"||c.code==="Space")&&(c.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(s),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),l&&this.domElement.classList.add("allow-touch-styles"),!_o&&a&&(sm(rm),_o=!0),n?n.appendChild(this.domElement):t&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),r&&this.domElement.style.setProperty("--width",r+"px"),this._closeFolders=o}add(e,t,n,r,s){if(Object(n)===n)return new nm(this,e,t,n);const o=e[t];switch(typeof o){case"number":return new tm(this,e,t,n,r,s);case"boolean":return new $p(this,e,t);case"string":return new im(this,e,t);case"function":return new ss(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,o)}addColor(e,t,n=1){return new em(this,e,t,n)}addFolder(e){const t=new Ls({parent:this,title:e});return this.root._closeFolders&&t.close(),t}load(e,t=!0){return e.controllers&&this.controllers.forEach(n=>{n instanceof ss||n._name in e.controllers&&n.load(e.controllers[n._name])}),t&&e.folders&&this.folders.forEach(n=>{n._title in e.folders&&n.load(e.folders[n._title])}),this}save(e=!0){const t={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof ss)){if(n._name in t.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);t.controllers[n._name]=n.save()}}),e&&this.folders.forEach(n=>{if(n._title in t.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);t.folders[n._title]=n.save()}),t}open(e=!0){return this._setClosed(!e),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(e){this._closed!==e&&(this._closed=e,this._callOnOpenClose(this))}show(e=!0){return this._hidden=!e,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(e=!0){return this._setClosed(!e),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const t=this.$children.clientHeight;this.$children.style.height=t+"px",this.domElement.classList.add("transition");const n=s=>{s.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const r=e?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!e),requestAnimationFrame(()=>{this.$children.style.height=r+"px"})}),this}title(e){return this._title=e,this.$title.innerHTML=e,this}reset(e=!0){return(e?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(e){return this._onChange=e,this}_callOnChange(e){this.parent&&this.parent._callOnChange(e),this._onChange!==void 0&&this._onChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onFinishChange(e){return this._onFinishChange=e,this}_callOnFinishChange(e){this.parent&&this.parent._callOnFinishChange(e),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onOpenClose(e){return this._onOpenClose=e,this}_callOnOpenClose(e){this.parent&&this.parent._callOnOpenClose(e),this._onOpenClose!==void 0&&this._onOpenClose.call(this,e)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(e=>e.destroy())}controllersRecursive(){let e=Array.from(this.controllers);return this.folders.forEach(t=>{e=e.concat(t.controllersRecursive())}),e}foldersRecursive(){let e=Array.from(this.folders);return this.folders.forEach(t=>{e=e.concat(t.foldersRecursive())}),e}}const Sr="Paint faces",Ps="Vertex selection",Qo="Vertex edition",Mt={mode:Sr,color:"#ff0000",rotate:"",scale:1,radius:1,selectionColor:"#00ff00","Reset colors":tl};let Ei,ti;function am(){const i=new Ls;i.add(Mt,"mode",[Sr,Ps,Qo]).onChange(om),Ei=i.addFolder("Paint faces"),Ei.addColor(Mt,"color"),ti=i.addFolder("Select vertices"),ti.add(Mt,"radius",.5,1),ti.addColor(Mt,"selectionColor"),ti.add(Mt,"Reset colors"),i.addFolder("Transform").add(Mt,"scale",.5,2.5).onChange(um),el(),Ei.show()}function om(){el(),Sr===Mt.mode?Ei.show():Ps===Mt.mode?(ti.show(),vs(!0)):Qo===Mt.mode&&(il(!0),vs(!0))}function el(){il(!1),vs(!1),tl(),Ei.hide(),ti.hide()}function tl(){nn.forEach(i=>{i.material.color.set(0)})}let ri={};function lm(){kp(),qp(),fm(),hm()}function cm(){if(Sr===Mt.mode){let i=xs.intersectObject(Dt);if(i.length>0){const e=i[0].face,t=new We(Mt.color),n=Dt.geometry.getAttribute("color");n.setXYZ(e.a,t.r,t.g,t.b),n.setXYZ(e.b,t.r,t.g,t.b),n.setXYZ(e.c,t.r,t.g,t.b),n.needsUpdate=!0}}else if(Ps===Mt.mode){let i=xs.intersectObject(Dt);i.length>0&&nn.forEach(e=>{Mt.radius>dm(e.position,i[0].point)&&e.material.color.set(Mt.selectionColor)})}}function um(i){Dt.scale.set(i,i,i),Ai.scale.set(i,i,i),nn.forEach(e=>{const t=Object.values(ri[e.id].icosahedron)[0];let n=Dt.getVertexPosition(t,new P);n=Dt.localToWorld(n),e.position.set(n.x,n.y,n.z),e.scale.set(i,i,i)})}function hm(){for(let i=0;i<nn.length;i++){let e=nn[i];ri[e.id]=[],ri[e.id].icosahedron=vo(Dt,e.position),ri[e.id].icosahedronWireframe=vo(Ai,e.position)}}function vo(i,e){const t=i.geometry.getAttribute("position");let n=[];for(let r=0;r<t.count;r++){const s=i.getVertexPosition(r,new P);nl(s,e)&&n.push(r)}return n}function dm(i,e){return Math.sqrt(Math.pow(e.x-i.x,2)+Math.pow(e.y-i.y,2)+Math.pow(e.z-i.z,2))}const nn=[];function fm(){const i=Dt.geometry.getAttribute("position"),e=[];for(let t=0;t<i.count;t++){const n=Dt.getVertexPosition(t,new P);if(!mm(e,n)){e.push(n);const r=new zt(new Cs(.075),new Ci({color:0}));r.position.set(n.x,n.y,n.z),nn.push(r),Pi.add(r)}}}function vs(i){for(let e=0;e<nn.length;e++)nn[e].visible=i}function pm(i){const e=i.object.id,t=i.object.position;xo(Dt,ri[e].icosahedron,t),xo(Ai,ri[e].icosahedronWireframe,t)}function nl(i,e,t=5){return i.x.toFixed(t)===e.x.toFixed(t)&&i.y.toFixed(t)===e.y.toFixed(t)&&i.z.toFixed(t)===e.z.toFixed(t)}function mm(i,e){for(let t=0;t<i.length;t++)if(nl(i[t],e))return!0;return!1}function xo(i,e,t){const n=i.geometry.getAttribute("position");t=i.worldToLocal(t.clone()),e.forEach(r=>{n.setXYZ(r,t.x,t.y,t.z)}),i.geometry.boundingSphere=null,i.geometry.boundingBox=null,n.needsUpdate=!0}let or;function gm(){_m(),vm(),xm()}function il(i){or.enabled=i}function _m(){const t=new Fp(50,20);t.position.y=-5,Pi.add(t)}function vm(){const i=new Gp(ci,Er.domElement);i.enablePan=!1,i.mouseButtons={MIDDLE:un.DOLLY,RIGHT:un.ROTATE}}function xm(){or=new Vp(nn,ci,Er.domElement),or.enabled=!1,or.addEventListener("drag",pm)}const xs=new Jo,as=new Ce;Mm();window.addEventListener("resize",Em);window.addEventListener("click",Sm);rl();function Mm(){lm(),gm(),am()}function rl(){requestAnimationFrame(rl),Er.render(Pi,ci)}function Em(){ci.aspect=window.innerWidth/window.innerHeight,ci.updateProjectionMatrix(),Er.setSize(window.innerWidth,window.innerHeight)}function Sm(i){as.x=i.clientX/window.innerWidth*2-1,as.y=-(i.clientY/window.innerHeight)*2+1,xs.setFromCamera(as,ci),cm()}
