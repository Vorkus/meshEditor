...
import {controlsIsActive} from "./helpers";
...
export function intersects(raycaster) {
    if (!controlsIsActive) {
        ...
        if (intersects.length > 0) {
            ...
            // if (undefined === lastVisitedFace || (face.a !== lastVisitedFace.a && face.b !== lastVisitedFace.b && face.c !== lastVisitedFace.c)) {
                ...
                lastVisitedFace = face;


                console.log(face, lastVisitedFace);
            // }
        }
    }
}
...
function buildIcosahedron(object) {
    ...
    // Buffer geometries are indexed by default
